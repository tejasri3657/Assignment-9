...
\vec{A}=I\vec{A}
\\
\myvec{1 & -1 & \vrule & 1 & 0 \\ 2 & 3 & \vrule & 0 & 1}\vec{A}
\end{align}
Applying elementary transformations on $\vec{A}$ as follows
\begin{align}
\xleftrightarrow{R_2\leftarrow R_2-2R_1}   
\myvec{1 & -1 & \vrule & 1 & 0 \\ 0 & 5 & \vrule & -2 & 1}\vec{A}
\\
\xleftrightarrow{R_2\leftarrow \frac{R_2}{5}}
\myvec{1 & -1 & \vrule & 1 & 0 \\ 0 & 1 & \vrule & \frac {-2}{5} & \frac {1}{5}}\vec{A}
\\
\xleftrightarrow{R_2\leftarrow R_1+R_2}
\myvec{1 & 0 & \vrule & \frac{3}{5} & \frac{1}{5} \\ 0 & 1 & \vrule & \frac{-2}{5} & \frac{1}{5}}\vec{A}
\end{align}
\begin{align}
